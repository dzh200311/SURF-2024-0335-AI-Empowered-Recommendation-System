...
function init() {
    ...
    // 二十面缓冲几何体
    var geom = new THREE.TorusGeometry(100, 40, 100, 100);
    var geom2 = new THREE.TorusGeometry(100, 40, 70, 100);
    var geom3 = new THREE.CylinderGeometry(3, 3, 12, 14, 14);
    ...
    // //    opacity: 0.5
    // });
    var mat1 = new THREE.MeshPhongMaterial({ color: 0xe94d90,transparent: true });
    var mat2 = new THREE.MeshPhongMaterial({ color: 0xfdc2a5,transparent: true });
    var mat3 = new THREE.MeshPhongMaterial({ color: 0xffe600,transparent: true });
    var mat4 = new THREE.MeshPhongMaterial({ color: 0xa5befd,transparent: true });
    var mat5 = new THREE.MeshPhongMaterial({ color: 0xe94a80,transparent: true });

    var pl1 = new THREE.Mesh(geom3, mat3);
    var pl2 = new THREE.Mesh(geom3, mat3);
    var pl3 = new THREE.Mesh(geom3, mat3);
    var pl4 = new THREE.Mesh(geom3, mat4);
    var pl5 = new THREE.Mesh(geom3, mat4);
    var pl6 = new THREE.Mesh(geom3, mat4);
    var pl7 = new THREE.Mesh(geom3, mat5);
    var pl8 = new THREE.Mesh(geom3, mat5);
    var pl9 = new THREE.Mesh(geom3, mat5);
    var topTorus = new THREE.Mesh(geom, mat1);
    var bottomTorus = new THREE.Mesh(geom2, mat2);

    pl1.rotation.x= Math.PI / 2;pl1.rotation.z = Math.PI / 2;
    pl1.position.y += 41;pl1.position.x += 100;

    pl2.rotation.x= Math.PI / 2;pl2.rotation.z = Math.PI / 2;
    pl2.position.y += 41;pl2.position.z += 100;

    pl3.rotation.x= Math.PI / 2;pl3.rotation.z = Math.PI / 3;
    pl3.position.y += 41;pl3.position.z -= 100*1.414/2;pl3.position.x -= 100*1.414/2;

    pl4.rotation.x= Math.PI / 2;pl4.rotation.z = Math.PI /1.5;
    pl4.position.y += 35;pl4.position.z += 160*1.414/2;pl4.position.x -= 100*1.414/2;

    pl5.rotation.x= Math.PI / 2;pl5.rotation.z = Math.PI /1.2;
    pl5.position.y += 35;pl5.position.z -= 40*1.414/2;pl5.position.x += 100*1.414/2;

    pl6.rotation.x= Math.PI / 2;pl6.rotation.z = Math.PI /2;
    pl6.position.y += 41;pl6.position.x -= 100;

    pl7.rotation.x= Math.PI / 2;pl7.rotation.z = Math.PI /3;
    pl7.position.y += 35;pl7.position.z += 160*1.414/2;pl7.position.x += 100*1.414/2;

    pl8.rotation.x= Math.PI / 2;pl8.rotation.z = Math.PI /1.5;
    pl8.position.y += 41;pl8.position.z -= 90;pl8.position.x +=15;

    pl9.rotation.x= Math.PI / 2;pl9.rotation.z = Math.PI/1.5 ;
    pl9.position.y += 37;pl9.position.z += 90;pl9.position.x -=95;
